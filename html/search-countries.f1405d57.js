...
})({"gPLhO":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "e9f40db0f1405d57";
...
},{}],"ffRdM":[function(require,module,exports) {
...
function onSearch(e) {
    ...
    (0, _fetchCountriesDefault.default)(name).then((countries)=>{
        ...
        if (countries.length === 1) renderCountryCard(countries);
    }).catch((error)=>{
        console.log(error);
        cleanHtml();
        notifyFailure();
    ...
    const cardMarkup = `
        <div class="card">
          <div class="card__box">
            ...
            <span class="card__text">${name !== "Russian Federation" ? name : "Terrorist state"}</span>
          </div>
          <ul class="list">
            <li class="list__item">
              <p class="list__text">Capital: <span class="list__subtext">${capital !== "Moscow" ? capital : "Оркостан"}</span></p>
            </li>
            <li class="list__item">
...
function renderCountryList(countries) {
    const listMarkup = countries.map(({ name , flags: { svg  }  })=>`<li class="country-list__item">
...
},{"../css/styles.css":"1CY4s","./fetchCountries":"dKuy9","lodash.debounce":"3JP5n","notiflix/build/notiflix-notify-aio":"eXQLZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"dKuy9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function fetchCountries(name) {
    return fetch(`${BASE_URL}name/${name}${SEARCH_PARAMS}`).then((response)=>{
        if (response.status === 404) throw new Error("This country not exist");
...
},{}]},["gPLhO","ffRdM"], "ffRdM", "parcelRequireabb0")

//# sourceMappingURL=search-countries.f1405d57.js.map
